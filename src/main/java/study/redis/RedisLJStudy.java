...
public class RedisLJStudy {

    private static final String ipAddr = "39.106.185.198";
    private static final int port = 6379;
    private static final String password = "c147258369";
    private static Jedis jedis= null;

    static {
        jedis = JedisUtil.getInstance().getJedis(ipAddr, port,password);
    }
